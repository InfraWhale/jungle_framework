...
public class NaverApiService {
    ...
    public List<ItemDto> searchItems(String query) {
        ...
        headers.add("X-Naver-Client-Id", "CrCqw5a8HrMpjIH9ig_Z");
        headers.add("X-Naver-Client-Secret", "xvu9Z0UCbe");
        String body = "";

        HttpEntity<String> requestEntity = new HttpEntity<String >(body, headers);

        ResponseEntity<String> responseEntity =
                rest.exchange("https://openapi.naver.com/v1/search/shop.json?display=15&query="
